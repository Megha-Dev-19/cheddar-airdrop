...
const { getRecentDropId } = require("./utils/general")
...
async function nftDropNear(){
	...
	try {
		await fundingAccount.functionCall({
			...
			args: {
				public_keys: pubKeys,
				deposit_per_use: parseNearAmount("0.01"),
				nft: {
	...
	try {	
		...
		console.log('error nft_transfer_call ', e);
        throw new Error(e)
	}
	var dropInfo = {};
        ...
        let linkdropUrl = `https://keypom.xyz/claim/v2.keypom.near#${keyPair.secretKey}`;
